...
object TermThemes {
    ...
    val Dark = theme(
        ...
        ansi = intArrayOf(
            0xFF9E9E9E.toInt(), 0xFFFF6B68.toInt(), 0xFF5AF78E.toInt(), 0xFFF3F99D.toInt(),
            0xFF57C7FF.toInt(), 0xFFFF6AC1.toInt(), 0xFF9AEDFE.toInt(), 0xFFF1F1F0.toInt(),
            0xFFCCCCCC.toInt(), 0xFFFF8B88.toInt(), 0xFF7AFF9E.toInt(), 0xFFFFFFB5.toInt(),
    ...
    val SolarizedDark = theme(
        ...
        ansi = intArrayOf(
            0xFF93A1A1.toInt(), 0xFFFF5F56.toInt(), 0xFFA3E635.toInt(), 0xFFFFD54F.toInt(),
            0xFF4FA8E8.toInt(), 0xFFF472B6.toInt(), 0xFF2AA198.toInt(), 0xFFEEE8D5.toInt(),
            0xFFFDF6E3.toInt(), 0xFFFF7B72.toInt(), 0xFF7EE787.toInt(), 0xFFFDE047.toInt(),
            0xFF83C5F7.toInt(), 0xFFA78BFA.toInt(), 0xFF67E8F9.toInt(), 0xFFFFFFFF.toInt()
        )
    )
    ...
    val Dracula = theme(
        ...
        ansi = intArrayOf(
            0xFF9AA5CE.toInt(), 0xFFFF5555.toInt(), 0xFF50FA7B.toInt(), 0xFFF1FA8C.toInt(),
            0xFFBD93F9.toInt(), 0xFFFF79C6.toInt(), 0xFF8BE9FD.toInt(), 0xFFF8F8F2.toInt(),
            0xFFC8D3F5.toInt(), 0xFFFF6E6E.toInt(), 0xFF69FF94.toInt(), 0xFFFFFFA5.toInt(),
            0xFFD6ACFF.toInt(), 0xFFFF92DF.toInt(), 0xFFA4FFFF.toInt(), 0xFFFFFFFF.toInt()
        )
    )

    val all: List<TerminalTheme> = listOf(
        Paper, Dark, SolarizedDark, SolarizedLight, Dracula
    )
